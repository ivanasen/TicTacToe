...
public class Constants {
    ...
    public static final String FONT_NAME = "fonts/Raleway-Thin.ttf";
    public static final String GAME_FONT_FILE = "fonts/game_font.fnt";
    public static final String GAME_FONT_IMG = "fonts/game_font.png";
    ...
    public static final int SCORE_FONT_SIZE = 46;
